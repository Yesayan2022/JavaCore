...
public interface Command {
    ...
    String DELET_COMPANY = "7";
    String DELET_EMPLOYEE = "8";
    ...
    static void printCommands() {
        ...
        System.out.println("Please input " + PRINT_COMPANIES + " for PRINT_COMPANIES");
        System.out.println("Please input " + PRINT_EMPLOYEES + " for PRINT_EMPLOYEES");
        ...
        System.out.println("Please input " + DELET_COMPANY + " for DELET_COMPANY");
        System.out.println("Please input " + DELET_EMPLOYEE + " for DELET_EMPLOYEE");
